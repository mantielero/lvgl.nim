...
proc main =
  ...
  lv_style_set_shadow_ofs_y(addr(style_base), 5)
  lv_style_set_shadow_opa(addr(style_base), LV_OPA_50)
  ...
  var obj_base: ptr lv_obj_t = lv_obj_create(lv_scr_act())
  ...
  var obj_warning: ptr lv_obj_t = lv_obj_create(lv_scr_act())
