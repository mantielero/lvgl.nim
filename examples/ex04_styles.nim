...
proc styleInit*() =
  ...
  lv_style_set_bg_opa(addr(style_btn), LV_OPA_COVER)
  ...
  lv_style_set_border_opa(addr(style_btn), LV_OPA_20)
  ...
  lv_style_set_color_filter_opa(addr(style_btn_pressed), LV_OPA_20)
...
proc main =
  ...
  var btn2: ptr lv_obj_t = lv_btn_create(lv_scr_act())
